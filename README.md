...
### 인공지능전환(AX), 학교는 무엇을·어떻게 준비해야 하는가

교사 · 학교 관리자 · 교육정책 담당자를 위한 **정책 → 전략 → 현장 → 윤리** 통합 안내서

<br>

[![바로 읽기](https://img.shields.io/badge/📖_바로_읽기-Live_Site-b45309?style=for-the-badge)](https://tigerjk9.github.io/Educational-handout/)
&nbsp;
...
| | 장 | 유형 | 핵심 |
|:--:|---|:--:|---|
| **1** | [AX 개관과 공교육의 특수성](https://tigerjk9.github.io/Educational-handout/overview/AX_Overview_Chapter.html) | 📖 챕터 | 전산화→DX→AX, 공교육이 기업과 다른 5가지 |
| **2** | [국내외 정책·동향](https://tigerjk9.github.io/Educational-handout/policy/Policy_Trends_Chapter.html) | 📖 챕터 | AI 디지털교과서의 부침, UNESCO·OECD·주요 7개국 |
| **3** | [6대 영역 전략 프레임워크](https://tigerjk9.github.io/Educational-handout/framework/Strategy_Framework_Chapter.html) | 📖 챕터 | 거버넌스·인프라·교원역량·교육과정·평가·윤리 |
...
**🔎 근거 기반**
추측 없이 교육부·KERIS·개인정보위·AI 기본법·UNESCO·OECD 등 공식 자료만 인용. 자료 수집일 2026-07-05.

</td>
<td width="33%" valign="top">

**🛡️ 다관점 검증**
사실 정확성·교육 효과·초보 재현성·실무 현실성·논리 일관성 5개 관점으로 교차 검토 후 반영.

</td>
<td width="33%" valign="top">

**🎨 읽기 좋게**
2단 레이아웃, 전체·페이지 내 검색, SVG 도식, amber 테마. 모바일까지 대응.

</td>
</tr>
</table>

> 📌 정책은 계속 바뀝니다. 각 장에 표시된 출처에서 최신 상태를 확인하며 읽으시길 권합니다.
...
**김진관(닷커넥터)** — 배움·나눔·성장을 추구하는 연결주의자. 블로그 [tigerjk9.github.io](https://tigerjk9.github.io/)에서 AI·교육 관련 글을 연재합니다. 이 핸드북의 6장(에이전트) 인사이트는 저자의 블로그 글(교사를 위한 AI 에이전트 위임, 에이전트형 코딩의 효율의 덫·전문성의 위기, 교사의 마지막 병목은 이해력 등)에 근거합니다.

<div align="center">
<sub>저자 김진관(닷커넥터) · 한국 초·중·고 공교육 · 2026년 상반기 정책 기준 · 자료 수집일 2026-07-05</sub>
</div>
